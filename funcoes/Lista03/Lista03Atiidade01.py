...
artista = str.upper(input("Digite o nome do artista que deseja calcular o valor das obras: "))

valor_Obra = 0
for i in range(indice):
    if artista in listaObra[i][1]:
        valor_Obra += listaObra[i][3]
print(f"R${valor_Obra:.2f}")