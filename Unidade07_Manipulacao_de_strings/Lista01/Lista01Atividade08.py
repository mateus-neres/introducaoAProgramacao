'''8. Escreva uma função TestaPalindromo que receba como entrada uma palavra e retorne True ou
False, indicando se ela é ou não um palíndromo. (Dica: utilize a função criada na questão 5)
